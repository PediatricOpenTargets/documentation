...
# DGD/CHOP P30 DNA Panel data are not currently being used, so filter out
...
# DGD/CHOP P30 Panel data are not currently being used, so filter out
  filter(Dataset != 'CHOP P30 Panel') -> dataset_counts
